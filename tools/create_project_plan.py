...
def main():
    ...
    table(d, ["阶段", "范围", "完成标志"], [
        ...
        ("P2：图表、引用与确认工作台（3-4 周）", "匹配预览、重复选择、captions.yaml/links.yaml、图表版式预检、题注/图注/交叉引用及 [[cite:key]] 引用占位符。", "所有图表、链接和文中引用均可人工确认并生成审计清单。"),
